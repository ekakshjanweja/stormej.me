...
export function PlayStore({ size = 140, ...props }: PlayStoreProps) {
  return (
    <svg
      ...
      {...props}
    >
      <linearGradient id="playStoreGreen" gradientUnits="userSpaceOnUse" x2="261.746" y1="112.094" y2="112.094">
        <stop offset="0" stopColor="#63be6b" />
        <stop offset="0.506" stopColor="#5bbc6a" />
        <stop offset="1" stopColor="#4ab96a" />
      </linearGradient>
      <linearGradient id="playStoreBlue" gradientUnits="userSpaceOnUse" x1="0.152" x2="179.896" y1="223.393" y2="223.393">
        <stop offset="0" stopColor="#3ec6f2" />
        <stop offset="1" stopColor="#45afe3" />
      </linearGradient>
      <linearGradient id="playStoreYellow" gradientUnits="userSpaceOnUse" x1="179.896" x2="407.976" y1="229.464" y2="229.464">
      ...
      <linearGradient id="playStoreRed" gradientUnits="userSpaceOnUse" x1="1.744" x2="272.296" y1="345.521" y2="345.521">
