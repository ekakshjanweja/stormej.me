...
<Links
  items={[
    ...
    { label: "play store", href: "https://play.google.com/store/apps/details?id=com.domilabs.domi" },
    { label: "app store", href: "https://apps.apple.com/us/app/digital-domi/id6738277048" },
  ]}
/>
