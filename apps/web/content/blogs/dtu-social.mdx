...
I am Ekaksh Janweja, a pre-final year student at Delhi Technological University, and together with my friend [Aryan Sidhwani](https://www.linkedin.com/in/aryan-sidhwani/) (trust me, he makes things work), I embarked on a journey to create [dtu.social](http://dtu.social), a proximity chat app aimed at connecting students with similar interests and goals.

<Callout type="tip" title="try it out">
You can check out the app on the [Play Store](https://play.google.com/store/apps/details?id=com.app.dtusocial).
</Callout>
...
<Cards>
  <Card title="Flutter" description="cross-platform UI for Android, iOS, and web from a single codebase" />
  <Card title="Firebase" description="auth + Cloud Firestore for real-time chat" />
  <Card title="Riverpod" description="state management with first-class Future and Stream support" />
  <Card title="Geolocator" description="location tracking for proximity-based matching" />
  <Card title="Routemaster" description="centralized route definitions for navigation" />
  <Card title="MVC" description="clean separation of concerns" />
</Cards>
...
<Tabs items={["FutureProvider", "StreamProvider"]}>
<Tab value="FutureProvider">
...
<Accordions>
  <Accordion title="1. Coordination as a two-man team">
  ...
  <Accordion title="2. UI design struggles">
  ...
  <Accordion title="3. Firestore data structure optimization">
  ...
  <Accordion title="4. Deploying the app to the Play Store">
    Getting our app on the Play Store was complex. We tackled forms, explained location use, and adhered to policies. Despite the hurdles, dtu.social went live.
  </Accordion>
</Accordions>

## Lastly,

I would be grateful if you guys try to use this app and drop me feedback on twitter [@ekaksh_janweja](https://twitter.com/ekaksh_janweja). And [Aryan](https://www.linkedin.com/in/aryan-sidhwani/) — let's build even more projects together.
