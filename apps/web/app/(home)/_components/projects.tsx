...
type ProjectRowEntry = ReturnType<typeof listProjects>[number];

function ProjectRowItem({ project }: { project: ProjectRowEntry }) {
	...
	const isExternal = !hasDescription && Boolean(project.website);
	...
	const onClick = useCallback(
		...
		[isExternal, project.slug, project.title]
	);
