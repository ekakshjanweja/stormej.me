...
function PhoneFrameLogo({ logo }: { logo: WorkLogoAsset }) {
...
function PhoneFrame({
	...
	return (
		...
		>
			{src ? (
				<PhoneFrameMedia src={src} title={title} useIphone17={useIphone17} />
			) : (
